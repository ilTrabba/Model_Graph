...
class MockSession:
    """Mock database session for compatibility with existing code"""
    
    def add(self, obj):
        """Mock add - actual saving happens through neo4j_service"""
        pass
    
    def commit(self):
        """Mock commit - actual saving happens through neo4j_service"""
        pass
    
    def delete(self, obj):
        """Mock delete - not implemented for Neo4j-only architecture"""
        pass
    
    def rollback(self):
        """Mock rollback - not implemented for Neo4j-only architecture"""
        pass
...
# Create a mock db instance for imports
db = MockDB()