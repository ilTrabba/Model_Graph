...
NUOVI OBIETTIVI PROGETTUALI:
   ...
   5.	Valutare l’utilizzo dell’ordinamento sorvolando problematiche legate all’uso parziale di metadati, quali i nomi dei layer, per il calcolo della distanza tra 2 modelli. -> NON IDONEO
